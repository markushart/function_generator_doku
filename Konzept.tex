...
Zu diesem Zweck wird die UART-Schnittstelle auf dem Basys3-Board genutzt.
Über diese kann der Nutzer Konfigurationsbefehle per Computer versenden, die dann vom Generator interpretiert werden.
Auch nutzerseitig wurde ein Python-Script geschrieben, mit dem die Kommunikation mit dem Generator vereinfacht wird.
