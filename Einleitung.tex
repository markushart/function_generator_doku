...
Ein Bit breite, digitale Signale und Begriffe aus dem Quellcode werden wie \bit{Bit} formatiert.
Bitvektoren, die sich aus mehreren Signalen zusammensetzen, werden mit der Formatierung \bitvect{Bitvektor} dargestellt.
Außerdem sehen analoge Signale wie folgt aus: \analog{analoges Signal} 