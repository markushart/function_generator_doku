...
\item \bit{D}: Richtung, in die der Zähler Zählen soll: 0 heißt aufwärts, 1 heißt abwärts
...
\end{verbatim}
\caption{Pseudocode zur Beschreibung des Teilungsalgorithmus.} \label{Comp:Arith:Division:Pseudo}
\end{figure}
