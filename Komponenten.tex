...
Dieser DAC verfügt über zwei DAC121S101-ICs von Texas Instruments die als jeweils ein Kanal die seriell empfangenen zwölf Bit Werte in eine analoge Spannung umwandeln (vgl. \cite{DAC121S101}, \cite{pmodDA2manual}).
...
\begin{figure} \centering
  ...
  \end{tikzpicture} 
  \caption{Clock-Tree} \label{Comp:clk:clocktree}
\end{figure}
